...
- **Last verified:** 2026-06-04 (#558 — exiftool hard-exit reaping re-enabled, gated on `_process_in_any_job` to avoid the #556 job-nesting corruption; #561 cancel-path hard-kill unchanged)
...
- **Last verified:** 2026-06-05 (#566 read/compute pipeline split — decouples disk-read latency from CPU decode, ~2.3× faster + sawtooth halved on mixed HDD+NAS)
