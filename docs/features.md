...
- **Related:** [PR #167](https://github.com/jackal998/photo-manager/pull/167) (Phase B — Simple/Beginner mode, cheatsheet, recent patterns, match highlight); [PR #168](https://github.com/jackal998/photo-manager/pull/168) (Phase C — Simple rename + 3-col cheatsheet); [#396](https://github.com/jackal998/photo-manager/issues/396) dropped the Simple/Regex mode toggle in favour of the dual-section view; QA scenario [`qa/scenarios/s31_simple_mode_regex.py`](../qa/scenarios/s31_simple_mode_regex.py).
- **Last verified:** 2026-05-24 (#396 dual-section refactor)
