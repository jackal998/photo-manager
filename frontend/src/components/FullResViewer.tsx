    ...
    <DialogPrimitive.Root open={isOpen} onOpenChange={(open) => { if (!open) closeFullRes(); }}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Overlay
          className="fixed inset-0 z-50 bg-scrim/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
        />
