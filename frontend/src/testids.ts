...
export const RESULT_COL_HEADER_ROW = "result-col-header-row";
...
export const MAIN_TOOLBAR = "main-toolbar";
export const MAIN_FILTER_INPUT = "main-filter-input";
export const MAIN_BULK_LABEL = "main-bulk-label";
export const MAIN_BULK_VERB_KEEP = "main-bulk-verb-keep";
export const MAIN_BULK_VERB_DELETE = "main-bulk-verb-delete";
export const MAIN_BULK_VERB_SKIP = "main-bulk-verb-skip";
export const MAIN_DELETE_CTA = "main-delete-cta";
export const MAIN_STATUS_STRIP = "main-status-strip";
export const MAIN_STATUS_DELETE_COUNT = "main-status-delete-count";
export const MAIN_STATUS_RECLAIM = "main-status-reclaim";
export const MAIN_DENSITY_TOGGLE = "main-density-toggle";
export const MAIN_DENSITY_COMFORTABLE = "main-density-comfortable";
export const MAIN_DENSITY_COMPACT = "main-density-compact";
export const MAIN_MENU_BAR = "main-menu-bar";
export const MAIN_SCAN_SUMMARY = "main-scan-summary";
...
export const SCAN_PHASH_PARITY_NOTE = "scan-phash-parity-note";
export const SCAN_DHASH_THRESHOLD = "scan-dhash-threshold";
export const SCAN_DHASH_PARITY_NOTE = "scan-dhash-parity-note";
...
export const EXECUTE_TITLE_BAR = "execute-title-bar";
export const EXECUTE_RESIZE_HANDLE = "execute-resize-handle";
export const EXECUTE_BODY = "execute-body";
...
export const EXECUTE_DELETE_CONFIRM_TOTALS = "execute-delete-confirm-totals";
export const EXECUTE_DELETE_CONFIRM_FOLDER = "execute-delete-confirm-folder";
export const EXECUTE_DELETE_CONFIRM_REASON = "execute-delete-confirm-reason";
...
export const FULLRES_TITLE_BAR = "fullres-title-bar";
export const FULLRES_RESIZE_HANDLE = "fullres-resize-handle";
...
export const ACTION_TITLE_BAR = "action-title-bar";
export const ACTION_RESIZE_HANDLE = "action-resize-handle";
export const ACTION_BODY = "action-body";
