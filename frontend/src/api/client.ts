...
export async function applyBestCopy(
  req: ApplyBestCopyRequest
): Promise<BulkDecideResult> {
  return postJsonOrConflict<BulkDecideResult>("/api/action/apply-best-copy", req);
}
