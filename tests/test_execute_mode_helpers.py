...
from app.views.main_window import _complete_delete_group_numbers
...
# ── _complete_delete_group_numbers ────────────────────────────────────────
...
class TestCompleteDeleteGroupNumbers:
    ...
    def test_sorts_output(self):
        ...
        assert _complete_delete_group_numbers(groups) == [1, 3, 5]
