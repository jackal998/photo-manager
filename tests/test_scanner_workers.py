...
# --- #548 — per-device worker count ---
# The device_key / is_remote_drive tests moved to tests/test_device_key.py
# when #622 Phase 2 extracted them to infrastructure/device_key.py.
...
# --- #565 — NAS server collapsing: the worker-count half of the contract ---
# (the device_key half now lives in tests/test_device_key.py)
